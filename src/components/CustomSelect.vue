...
<template>
  <div
    class="inline-flex relative h-10 rounded-md border border-grey-300 min-w-48"
  >
    <select
      v-model="value"
    ...
    <div
      class="grid absolute top-0 right-0 place-items-center pointer-events-none size-10"
    >
