<!-- ProcessClaimDetail.vue - Updated with improved institution name handling -->
<script setup>
...
import ProcessProvidedItemsMdl from '../../components/modals/ProcessProvidedItems.mdl.vue';
...
// Log for debugging
console.log('Process Claim Detail - Institution name:', institutionName.value);
console.log('Process Claim Detail - Route state:', route.state);
console.log('Process Claim Detail - Route query:', route.query);
</script>
  ...
  <DefaultPage>
        ...
        <div class="flex items-center gap-4">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-sm text-gray-500">Process Claim Details</p>
            </div>
          </div>
    ...
    <div class="flex justify-end pb-8 mt-4" v-if="canProcessWholeClaim">
      <Button type="primary" @click="openProcessWholeClaim" class="px-6 py-2.5 text-sm font-medium bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 rounded-lg shadow-md hover:shadow-lg transition-all duration-200">
        ...
        Process Entire Claim
      </Button>
    </div>

    <ProcessProvidedItemsMdl
      v-if="showItemsModal"
      :row="modalRow"
      :items="modalItems"
      :title="modalTitle"
