...
<template>
  <tr
    ...
    class="bg-white border-b transition-colors cursor-pointer hover:bg-blue-50"
  >
    <!-- Index -->
    ...
    <td class="relative p-4">
      <button
        ...
        aria-label="Actions"
        class="p-2 rounded-full transition-colors hover:bg-gray-200"
        type="button"
      >
      ...
      <div
        ...
        class="hidden absolute right-0 z-20 mt-2 w-48 bg-white rounded-md ring-1 ring-black ring-opacity-5 shadow-lg dropdown-menu"
      >
        <div class="py-1">
          <!-- View Policy -->
          <button
