...
import AcceptedQuotationRowCom from "@/features/quotation/components/AcceptedQuotationRow.vue";
  ...
  <DefaultPage v-model="search" placeholder="Search by institution or insured name...">
    ...
    <div class="flex flex-col gap-4">
      ...
      >
        <Table
          :pending="pending"
          :rowCom="AcceptedQuotationRowCom"
          :headers="{
            head: [
          ...
          :cells="{
            ...
            dateTypeInfo: (_: any, r: any) => ({
              acceptedDate: r.acceptedDate ? new Date(r.acceptedDate).toLocaleDateString('en-US', { year: 'numeric', month: 'short', day: 'numeric' }) : '—',
