...
// Handle native form submit (triggered by Enter key or button click)
...
<template>
  ...
  >
    ...
    <div class="grid w-full">
      <Form v-slot="{ submit }" id="login-form" @submit="handleSubmit(submit)" class="flex flex-col gap-8 w-full">
        <div class="space-y-4">
          <Input
            :focus="true"
